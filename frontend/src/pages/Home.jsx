  ...
  return <>
    ...
    <section>
      <div className='container'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
          ...
          <div className='py-[30px] px-5'>
            ...
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border-solid border-
      ...
      <div className='container'>
        <div className='flex items-center justify-between flex-col lg:flex-row'>
          ...
          <div className='xl:w-[670px]'>
            <h2 className='heading'>get virual treament <br />anytime.
            </h2>
            <ul className='pl-4'>
              <li className='text__para'>
                1. schedu;e the appoiment directory.
              </li>
              <li className='text__para'>
            ...
            md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-[6px] lg:gap-3'>
                  <p className='text-[10px] leading-[10px] lg:text-[14-x] lg:leading-5 text-headingColor
                   font-[600]'>
                    Tue, 24
                  </p>
                  <p className='text-[10px] leading-[10px] lg:text-[14-x] lg:leading-5 text-textColor
                   font-[400]'>
                    10:00AM
                  </p>
                </div>
              ...
              <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lf:py-[6px] lg:px-[10px]
